import pygame
from envs.bq_src.operator_env.op_Env import Op_Env
class Car_a_Env(Op_Env):
    def __init__(self, color, init_hex, id, type):
        super(Op_Env, self).__init__()
        # attr
        self.color = color
        self.id = id
        self.type = type  # 0 car_a 1 car_b 2 peo
